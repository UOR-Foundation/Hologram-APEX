...
If you want VSCode to recognize Python in kernels:
...
- Choose `./kernels/.venv/bin/python`

## Why `.venv` in kernels/?

- **Isolated**: Python stuff stays in kernels/ directory
...
- **For schema development**: Create `.venv` in kernels/ directory
