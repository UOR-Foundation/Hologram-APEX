      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center gap-6 text-center mb-20">
          ...
          <p className="max-w-[800px] text-xl leading-relaxed text-muted-foreground md:text-2xl">
            Connect with the UOR Foundation and Hologram team. We&apos;re here to help with questions, collaborations, and partnerships
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto space-y-10">
          <Card className="bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20">
            <CardHeader className="pb-6">
              <CardTitle className="text-3xl">Direct Contact</CardTitle>
              ...
              <div className="flex flex-col items-center text-center space-y-4 py-6">
                ...
                <div>
                  ...
                  <p className="text-base text-muted-foreground mt-3 max-w-2xl">
                    Reach out for technical inquiries, partnership opportunities, research collaborations, or general questions about Hologram and UOR protocols
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="bg-gradient-to-br from-secondary/5 to-primary/5 border-secondary/20">
            <CardHeader className="pb-6">
              <CardTitle className="text-3xl">Join the Community</CardTitle>
              <CardDescription className="text-lg leading-relaxed">
            ...
            <CardContent className="pt-0">
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <Link
                  href="https://uor-foundation.discourse.group"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-start gap-4 p-4 rounded-lg hover:bg-primary/5 transition-colors"
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Join technical discussions on Discourse
                    </p>
                  </div>
                </Link>
