...
The hologram runtime provides acceleration through canonical compilation.
...
Hologram Core Operations (Rust)
    ↓ compiles via
Canonical Compilation (pattern rewriting: H²=I, X²=I, etc.)
    ↓ produces
...
class HologramAcceleratedLinear(nn.Module):
    ...
    which compiles to canonical form.
...
def main():
    ...
    print("  - Build-time canonical compilation")
