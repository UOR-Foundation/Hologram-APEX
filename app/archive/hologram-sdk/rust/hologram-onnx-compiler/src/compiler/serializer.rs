...
use crate::compiler::{ExecutionResults, SerializerStats};
...
impl HoloSerializer {
    ...
    pub fn serialize(
        ...
        let total_bytes = HEADER_SIZE + manifest_size + address_space_size + hash_tables_size + metadata_size;
