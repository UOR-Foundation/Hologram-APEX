...
mod test_add {
    ...
    fn test_add_edge_cases() {
        ...
        let test_cases = vec![
            // Zeros
            (vec![0.0, 0.0, 0.0], vec![1.0, 2.0, 3.0], vec![1.0, 2.0, 3.0]),
            // Negatives
            (vec![-1.0, -2.0, -3.0], vec![1.0, 2.0, 3.0], vec![0.0, 0.0, 0.0]),
            // Large values
...
mod test_sub {
    ...
    fn test_sub_edge_cases() {
        ...
        let test_cases = vec![
            // Zeros
            (vec![1.0, 2.0, 3.0], vec![0.0, 0.0, 0.0], vec![1.0, 2.0, 3.0]),
            // Negatives
            (vec![1.0, 2.0, 3.0], vec![1.0, 2.0, 3.0], vec![0.0, 0.0, 0.0]),
            // Result negative
...
mod test_mul {
    ...
    fn test_mul_edge_cases() {
        ...
        let test_cases = vec![
            // Zeros
            (vec![1.0, 2.0, 3.0], vec![0.0, 0.0, 0.0], vec![0.0, 0.0, 0.0]),
            // Ones (identity)
            (vec![5.0, 10.0, 15.0], vec![1.0, 1.0, 1.0], vec![5.0, 10.0, 15.0]),
            // Negatives
