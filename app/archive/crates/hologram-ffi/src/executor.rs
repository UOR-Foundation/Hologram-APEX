...
//!
//! Provides handle-based API for creating and managing Circuit executors.
...
///
/// The executor uses Circuit CircuitExecutor under the hood,
...
pub fn new_executor() -> u64 {
    ...
    // Create Circuit executor with CPU backend
