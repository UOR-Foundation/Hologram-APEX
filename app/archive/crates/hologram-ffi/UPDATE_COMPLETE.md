...
All operations from hologram-core are now accessible through clean, idiomatic FFI bindings for Python, TypeScript, Kotlin, and other UniFFI-supported languages. The implementation follows best practices and maintains the performance characteristics of the underlying hologram-compiler engine.
