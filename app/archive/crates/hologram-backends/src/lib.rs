...
pub mod circuit_to_isa;

// Re-export public API
pub use backend::{Backend, BufferHandle, ExecutionParams, GaugeMetadata, LaunchConfig, PoolHandle};
pub use backends::{CpuBackend, CudaBackend, MetalBackend, WasmBackend};

// Re-export WebGPU backend (WASM GPU acceleration)
#[cfg(feature = "webgpu")]
pub use backends::WebGpuBackend;
