// Parallel reduction minimum compute shader
// Implements ReduceMin generator with workgroup-level reduction
//
// Corresponds to: reduce_min@c[0..N]
// Operation: output[0] = min(input[0..N])
//
...
fn main(
    ...
    if (gid < n) {
        ...
        // Initialize out-of-bounds elements to max float value
        shared_data[tid] = 3.40282347e+38; // f32::MAX
    }

    workgroupBarrier();

    // Parallel reduction in shared memory using min
