//! # Hologram Compiler - Unified 768-Cycle Quantum Computing & Circuit Compiler
//!
...
//! ## Overview
//!
//! The hologram compiler provides:
...
//! - **Circuit Compiler**: CircuitCompiler with canonicalization
...
// Circuit Compiler Modules (Organized)
pub mod automorphism; // automorphism_group, automorphism_search
pub mod canonical; // canonical_repr, canonicalization, pattern, rewrite, rules
pub mod class; // class_system, multi_class, types
pub mod compile; // compiler
pub mod complexity; // C0-C3 classification
pub mod factorization; // base96, orbit, optimal, tables
pub mod generators; // generators
pub mod ir; // ir, builder, normalization, lowering
pub mod lang; // ast, circuit, lexer, parser
...
// Re-export all public items from organized submodules
