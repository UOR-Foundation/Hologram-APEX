...
use crate::canonical::rules::RuleSet;
use crate::lang::ast::{Parallel, Phrase, Sequential};
            ...
            Phrase::Parallel(par) => {
                ...
                match &par.branches[0].items[0] {
                    Term::Operation { generator, target } => {
                        assert_eq!(*generator, crate::class::Generator::Mark);
                        if let crate::class::ClassTarget::Single(sigil) = target {
