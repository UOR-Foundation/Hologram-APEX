...
use crate::class::SigilComponents;
...
impl Automorphism {
    ...
    pub fn apply_to_components(self, comp: SigilComponents) -> SigilComponents {
        ...
        let d = crate::class::Modality::from_u8(d_val).expect("Invalid modality");
...
impl AutomorphismGroup {
    ...
    fn transform_phrase(&self, auto: &Automorphism, phrase: &crate::lang::ast::Phrase) -> crate::lang::ast::Phrase {
        use crate::lang::ast::Phrase;
    ...
    fn transform_parallel(&self, auto: &Automorphism, par: &crate::lang::ast::Parallel) -> crate::lang::ast::Parallel {
        use crate::lang::ast::Parallel;
    ...
    fn transform_sequential(
        &self,
        auto: &Automorphism,
        seq: &crate::lang::ast::Sequential,
    ) -> crate::lang::ast::Sequential {
        use crate::lang::ast::Sequential;
    ...
    /// Transform a term
    fn transform_term(&self, auto: &Automorphism, term: &crate::lang::ast::Term) -> crate::lang::ast::Term {
    ...
    fn transform_target(&self, auto: &Automorphism, target: &crate::class::ClassTarget) -> crate::class::ClassTarget {
        use crate::class::ClassTarget;
    ...
    fn transform_class_sigil(&self, auto: &Automorphism, sigil: &crate::class::ClassSigil) -> crate::class::ClassSigil {
        let transformed_index = self.apply(auto, sigil.class_index);

        crate::class::ClassSigil {
    ...
    fn transform_class_range(&self, auto: &Automorphism, range: &crate::class::ClassRange) -> crate::class::ClassRange {
...
mod tests {
    ...
    fn test_apply_to_circuit_identity() {
        ...
        let original = crate::lang::parser::parse(circuit).unwrap();
        let result = crate::lang::parser::parse(&transformed).unwrap();
    ...
    fn test_apply_to_circuit_simple() {
        ...
        assert!(crate::lang::parser::parse(&transformed).is_ok());
    }
    ...
    fn test_apply_to_circuit_sequential() {
        ...
        // Result should be parseable
        let parsed = crate::lang::parser::parse(&transformed);
        assert!(
            parsed.is_ok(),
